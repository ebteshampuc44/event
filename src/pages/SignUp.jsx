    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FCEB00]/10 via-white to-[#FCEB00]/5 pt-24 pb-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join Corn's Event and start your journey</p>
        </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FCEB00] focus:border-transparent transition-all duration-300 ${
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`block w-full pl-10 pr-10 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FCEB00] focus:border-transparent transition-all duration-300 ${
